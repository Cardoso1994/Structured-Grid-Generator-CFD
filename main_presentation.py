...
if malla == 'O':
    ...
    print(f"shape of airfoil: {M}")
    mallaNACA = mesh_c.mesh_C(R, N, perfil)
    print(f"shape of airfoil: {mallaNACA.M}")

print('M = ' + str(mallaNACA.M))
print('N = ' + str(mallaNACA.N))

start = time.perf_counter()
mallaNACA.gen_Poisson_v_(metodo='SOR', omega=0.95, aa=250, cc=10, linea_eta=0)
...
title = "Malla C"
file_save = "/home/cardoso/Tesis/presentacion/img/malla_c_flap.png"
file_save = "/home/cardoso/garbage/malla_c_flap.png"
fig = plt.figure()
...
plt.show()
mallaNACA.to_su2(
    '/home/cardoso/Tesis/presentacion/meshes/C/mesh_poisson_flap_vect.su2')
mallaNACA.to_txt_mesh(
  '/home/cardoso/Tesis/presentacion/meshes/C/mesh_poisson_flap_vect.mesh_txt')
