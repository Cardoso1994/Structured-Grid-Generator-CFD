...
\chapter{Resultados}
   ...
   $-30\si{\degree}$.
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_flap_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_flap_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_aspect_close}}

        \subfigure[Vista
          Completa $M=103$]{\label{fig:naca4415_flap_m_103_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_m_103_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=103$]{\label{fig:naca4415_flap_m_103_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_m_103_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_flap_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_flap_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_skew_close}}

        \subfigure[Vista
          Completa $M=103$]{\label{fig:naca4415_flap_m_103_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_m_103_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=103$]{\label{fig:naca4415_flap_m_103_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_flap_m_103_skew_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aspect_close}}

        \subfigure[Vista
          Completa $M=103$]{\label{fig:naca4415_c_m_117_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_m_117_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=103$]{\label{fig:naca4415_c_m_117_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_m_117_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_n_65_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_n_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_n_65_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_n_65_aspect_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_aa_38_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aa_38_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_aa_38_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aa_38_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_skew_close}}

        \subfigure[Vista
          Completa $M=103$]{\label{fig:naca4415_c_m_117_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_m_117_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=103$]{\label{fig:naca4415_c_m_117_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_m_117_skew_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_n_65_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_n_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_n_65_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_n_65_skew_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_aa_38_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aa_38_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_aa_38_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_aa_38_skew_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_flap_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aspect_close}}

        \subfigure[Vista
          Completa $M=183$]{\label{fig:naca4415_c_flap_m_183_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_m_183_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=183$]{\label{fig:naca4415_c_flap_m_183_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_m_183_aspect_close}}
    ...
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=85$]{\label{fig:naca4415_c_flap_n_85_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_n_85_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=85$]{\label{fig:naca4415_c_flap_n_85_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_n_85_aspect_close}}

        \subfigure[Vista
          Completa $a=36$]{\label{fig:naca4415_c_flap_aa_36_aspect_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aa_36_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=36$]{\label{fig:naca4415_c_flap_aa_36_aspect_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aa_36_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_flap_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_skew_close}}

        \subfigure[Vista
          Completa $M=183$]{\label{fig:naca4415_c_flap_m_183_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_m_183_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=183$]{\label{fig:naca4415_c_flap_m_183_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_m_183_skew_close}}
    ...
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=85$]{\label{fig:naca4415_c_flap_n_85_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_n_85_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=85$]{\label{fig:naca4415_c_flap_n_85_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_n_85_skew_close}}

        \subfigure[Vista
          Completa $a=36$]{\label{fig:naca4415_c_flap_aa_36_skew_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aa_36_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=36$]{\label{fig:naca4415_c_flap_aa_36_skew_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_aa_36_skew_close}}
    ...
    del código desarrollado como parte de este proyecto. En primera instancia
    se llevan a cabo análisis de flujo potencial, tema que se ha desarrollado
    en el capítulo~\ref{chap:potential}. De igual modo, se llevaron a cabo
    ...
    \begin{figure}[H]%[htbp!]
        \centering
        \subfigure[$\alpha = 4\si{\degree}$]{\label{fig:potential_flow_stream_4}
            \includegraphics[keepaspectratio, width=93mm]
            {./Imagenes/potential_flow_stream_4}}
          \subfigure[$\alpha = 6\si{\degree}$]{\label{fig:potential_flow_stream_6}
            \includegraphics[keepaspectratio, width=93mm]
            {./Imagenes/potential_flow_stream_6}}
          \subfigure[$\alpha = 8\si{\degree}$]{\label{fig:potential_flow_stream_8}\includegraphics[keepaspectratio,
            width=93mm]{./Imagenes/potential_flow_stream_8}}
          \subfigure[$\alpha = 10\si{\degree}$]{\label{fig:potential_flow_stream_10}\includegraphics[keepaspectratio,
            width=93mm]{./Imagenes/potential_flow_stream_10}}
        \caption{Líneas de corriente alrededor de perfil NACA 0012}
    ...
    \begin{figure}[H]%[htbp!]
        ...
        \caption{Gráfica de coeficiente de sustentación vs. ángulo de ataque
            para perfil NACA 2412}\label{fig:potential_flow_cl}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        ...
        width=150mm]{./Imagenes/su2/mc_vel_alfa_0.png}}
    ...
    \begin{figure}[htbp!]
        ...
        width=150mm]{./Imagenes/su2/mc_vel_alfa_10.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo C de un perfil NACA 0012 con
    ...
    \begin{figure}[htbp!]
        ...
        width=150mm]{./Imagenes/su2/mo_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
    ...
    \begin{figure}[htbp!]
        ...
        width=150mm]{./Imagenes/su2/mo_vel_alfa_10.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo O de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 10\si{\degree}$}
        \label{fig:mo_su2_10}
    ...
    \begin{figure}[htbp!]
        ...
        width=150mm]{./Imagenes/su2/mc_flap_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo C de un perfil NACA 0012 con
