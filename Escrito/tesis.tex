...
\begin{document}
    ...
    \nomenclature[]{DFC}{Dinámica de Fluidos Computacional}
    \nomenclature[]{EDP}{Ecuaciones Diferenciales Parciales}

    \nomenclature[]{$i$}{Indice i de malla estructurada}
    \nomenclature[]{$j$}{Indice j de malla estructurada}
    \nomenclature[]{$k$}{Indice k de malla estructurada}

    \nomenclature[]{$x$}{Eje de las ordenadas en el dominio físico}
    \nomenclature[]{$y$}{Eje de las abscisas en el dominio físico}
    \nomenclature[]{$\xi$}{Eje de las ordenadas en el dominio computacional}
    \nomenclature[]{$\eta$}{Eje de las abscisas en el dominio computacional}

    \nomenclature[]{$f$}{Función de una propiedad del flujo}

    \nomenclature[]{$\pdv{f}{x}$}{Derivada parcial de la propiedad del flujo
                    $f$ con respecto al eje $x$}
    \nomenclature[]{$\pdv[2]{f}{x}$}{Segunda derivada parcial de la propiedad
                    del flujo $f$ con respecto al eje $x$}
    \nomenclature[]{$\pdv[3]{f}{x}$}{Tercera derivada parcial de la propiedad
                    del flujo $f$ con respecto al eje $x$}
    \nomenclature[]{$\pdv[n]{f}{x}$}{N derivada parcial de la propiedad del
                    flujo $f$ con respecto al eje $x$}
    \nomenclature[]{$\pdv{f}{y}$}{Derivada parcial de la propiedad del flujo
                    $f$ con respecto al eje $y$}
    \nomenclature[]{$\pdv[2]{f}{y}$}{Segunda derivada parcial de la propiedad
                    del flujo $f$ con respecto al eje $y$}
    \nomenclature[]{$\pdv[3]{f}{y}$}{Tercera derivada parcial de la propiedad
                    del flujo $f$ con respecto al eje $y$}
    \nomenclature[]{$\pdv[n]{f}{y}$}{N derivada parcial de la propiedad del
                    flujo $f$ con respecto al eje $y$}
    \nomenclature[]{$\pdv{f}{x}{y}$}{Derivada parcial mixta de la propiedad del
                    flujo $f$ con respecto a los ejes $x$ y $y$}

    \nomenclature[]{$f_{i, j}$}{Aproximación del valor de la propiedad $f$
                    del flujo en un punto $i, j$ de la malla}
    \nomenclature[]{$\Delta x$}{Intervalo entre puntos en dirección del eje
                    $x$}
    \nomenclature[]{$\Delta y$}{Intervalo entre puntos en dirección del eje
                    $y$}
    \nomenclature[]{$O()$}{Error de truncamiento de la serie de Taylor}

    \nomenclature[]{$L(x)$}{Polinomio de Lagrange en función de $x$}
    \nomenclature[]{$L$}{Base polinómica de Lagrange}
    \nomenclature[]{$H(x)$}{Polinomio de Hermite en función de $x$}
    \nomenclature[]{$x_0$}{Coordenada x de un punto en la frontera interna de
                    la malla}
    \nomenclature[]{$y_0$}{Coordenada x de un punto en la frontera interna de
                    la malla}
    \nomenclature[]{$x_1$}{Coordenada x de un punto en la frontera externa de
                    la malla}
    \nomenclature[]{$y_1$}{Coordenada x de un punto en la frontera externa de
                    la malla}
    \nomenclature[]{$r$}{Punto arbitrario de la malla expresado en coordenadas
                    del dominio computacional $\xi, \eta$}
    \nomenclature[]{$P_\xi$}{Proyector del dominio computacional al dominio
                    físico mapeando las coordenadas en el eje $\xi$}
    \nomenclature[]{$P_\eta$}{Proyector del dominio computacional al dominio
                    físico mapeando las coordenadas en el eje $\eta$}

    \nomenclature[]{$\xi_{xx}$}{Segunda derivada parcial de $\xi$ con respecto
                    a $x$}
    \nomenclature[]{$\xi_{yy}$}{Segunda derivada parcial de $\xi$ con respecto
                    a $y$}
    \nomenclature[]{$\eta_{xx}$}{Segunda derivada parcial de $\eta$ con
                    respecto a $x$}
    \nomenclature[]{$\eta_{yy}$}{Segunda derivada parcial de $\eta$ con
                    respecto a $y$}
    \nomenclature[]{$x_{\xi\xi}$}{Segunda derivada parcial de $x$ con respecto
                    a $\xi$}
    \nomenclature[]{$x_{\xi\eta}$}{Derivada parcial mixta de $x$ con respecto
                    a $\xi$ y $\eta$}
    \nomenclature[]{$x_{\eta\eta}$}{Segunda derivada parcial de $x$ con
                    respecto a $\eta$}
    \nomenclature[]{$y_{\xi\xi}$}{Segunda derivada parcial de $y$ con respecto
                    a $\xi$}
    \nomenclature[]{$y_{\xi\eta}$}{Derivada parcial mixta de $y$ con respecto
                    a $\xi$ y $\eta$}
    \nomenclature[]{$y_{\eta\eta}$}{Segunda derivada parcial de $y$ con
                    respecto a $\eta$}

    \nomenclature[]{$P$}{Función de forzado en dirección del eje $\xi$ para la
                    solución de la ecuación de Poisson}
    \nomenclature[]{$Q$}{Función de forzado en dirección del eje $\eta$ para la
                    solución de la ecuación de Poisson}
    \nomenclature[]{$J$}{Jacobiano de la transformación}
    \nomenclature[]{$I$}{Inverso del Jacobiano de la transformación}

    \nomenclature[]{$X$}{Coordenada en el eje $x$ del dominio computacional de
                    un punto perteneciente a la malla}
    \nomenclature[]{$Y$}{Coordenada en el eje $y$ del dominio computacional de
                    un punto perteneciente a la malla}
...
\chapter{Resultados}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio,
            width=0.5\textwidth]{./img/potential_flow_cl}
    ...
    \begin{figure}
        \centering
        \includegraphics[keepaspectratio,
        width=0.7\textwidth]{./img/cp_comparison_10.png}
