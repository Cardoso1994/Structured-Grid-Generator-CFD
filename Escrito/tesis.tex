...
\begin{titlepage}
    \begin{center}
        % \begin{figure}[htbp!]
        %     \centering
            \includegraphics[keepaspectratio, width=76mm]{./img/ipn_logo}
        % \end{figure}
    \vspace*{2mm}
    \rule{\textwidth}{1.5pt}\\
    \vspace*{2mm}
...
\end{titlepage}
    ...
    system of elliptical partial differential equations. Computational
...
\pagenumbering{arabic}
    ...
    OpenFOAM y SU2 con los cuales la interacción con el programa mediante la
...
\paragraph{}
    ...
    las cuales, en sus sistemas de coordenadas computacional, pueda ser aplicado
    el método de diferencias finitas para la solución de problemas.
    %
    %
    %
    %
...
\chapter{Resultados}
    ...
    \begin{figure}[htbp!]
        ...
        \caption[Malla tipo O con perfil y flap NACA 4415]{Malla tipo O con
            ...
            $\alpha = 0\si{\degree}$}\label{fig:naca4415_flap}
...
\chapter{Métodos Numéricos Iterativos}\label{appIter}
    ...
    \paragraph*{}
        ...
        llevar a cabo la solcuión del sistema. La idea de estos métodos, tal y
