   ...
   varía.
    ...
    \begin{figure}[H]%[htbp!]
        ...
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_cp_-4}\includegraphics[keepaspectratio,
          ...
          \subfigure[$\alpha = 0\si{\degree}$]{\label{fig:potential_flow_cp_0}\includegraphics[keepaspectratio,
    ...
    \begin{figure}[H]%[htbp!]
        ...
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_stream_-4}\includegraphics[keepaspectratio,
          ...
          \subfigure[$\alpha = 0\si{\degree}$]{\label{fig:potential_flow_stream_0}\includegraphics[keepaspectratio,
    ...
    \begin{figure}[H]%[htbp!]
        \centering
        \subfigure[$\alpha = 4\si{\degree}$]{\label{fig:potential_flow_stream_4}\includegraphics[keepaspectratio,
            width=93mm]{./Imagenes/potential_flow_stream_4}}
          \subfigure[$\alpha = 6\si{\degree}$]{\label{fig:potential_flow_stream_6}\includegraphics[keepaspectratio,
            width=93mm]{./Imagenes/potential_flow_stream_6}}
    ...
    \begin{figure}[H]%[htbp!]
        ...
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_2412_cp_-4}\includegraphics[keepaspectratio,
          ...
          \subfigure[$\alpha = 0\si{\degree}$]{\label{fig:potential_flow_2412_cp_0}\includegraphics[keepaspectratio,
            width=93mm]{./Imagenes/potential_flow_cp_0}}
    ...
    \begin{figure}[H]%[htbp!]
        ...
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_2412_stream_-4}\includegraphics[keepaspectratio,
          ...
          \subfigure[$\alpha = 0\si{\degree}$]{\label{fig:potential_flow_2412_stream_0}\includegraphics[keepaspectratio,
