...
\chapter{Resultados}
    ...
    \paragraph*{}
        ...
        $\alpha = 90\si{\degree}$, condición en la cual todavía se muestra una malla dentro
        del rango de usabilidad. Mientras que la figura~\ref{fig:naca4415_90}
        muestra un acercamiento al perfil con un ángulo de ataque $\alpha =
        -90\si{\degree}$, e ilustra una malla de mala calidad en el borde de
        salida.
