...
\begin{document}
    \begin{titlepage}
		\begin{center}
			\begin{figure}
				\begin{center}
					\includegraphics[keepaspectratio, width=3cm]{./img/ipn-logo}
				\end{center}
			\end{figure}
		\rule{100mm}{0.3mm}\\
		\vspace*{8mm}
...
\section{Tipos de Mallas Estructuradas}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio, width=170mm]{./img/tipos-de-malla}
...
\section{Generación de mallas mediante EDP}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio, width=110mm]{./img/parabolic_modified_boundary.png}
...
\paragraph*{}
    Se implementaron también algortimos para la generación de mallas tipo O a
    través de la solución tanto de EDP hiperbólicas como parabólicas. Sin
    embargo, dado el comportamiento matemático que presentan dichos sistemas,
    no se obtuvieron resultados favorables en estos dos casos.
