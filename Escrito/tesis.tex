...
\chapter{Resultados}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[40\si{\degree} Vista del perfil]{\label{fig:naca4415_40_far}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_40_far}}
        \subfigure[40\si{\degree} Vista del borde de salida]{\label{fig:naca4415_40_close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_40_close}}
        \caption[Malla tipo O con perfil NACA4415 a 40\si{\degree}]{Malla tipo O con perfil NACA4415
                        con ángulo de ataque 40\si{\degree}. Acercamiento al perfil y al borde de salida}
        \label{fig:naca4415_40}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Flap a 60\si{\degree}]{\label{fig:naca4415_flap_60}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_60}}
        \subfigure[Acercamiento a perfil]{\label{fig:naca4415_flap_-25}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_-25}}
        \caption[Malla tipo O con perfily flap NACA4415]{Malla tipo O con perfil
             y flap NACA4415, ambos con ángulo de ataque 0\si{\degree}}
        \label{fig:naca4415_flap_60_-25}
    \end{figure}

    % \begin{figure}
    % \inputpgf{./Imagenes}{test.pgf}
    % \end{figure}
