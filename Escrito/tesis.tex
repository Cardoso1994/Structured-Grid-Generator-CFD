...
\section{Generación de mallas mediante EDP}
    ...
    \paragraph*{}
        ...
        \begin{figure}[htbp!]
            \centering
            \includegraphics[width=110mm]{./Imagenes/aspect_ansys.png}
    ...
    \paragraph*{}
        ...
        \begin{figure}[htbp!]
            \centering
            \includegraphics[width=110mm]{./Imagenes/aspect_verdict.png}
...
\chapter{Desarrollo Práctico}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=110mm]{./Imagenes/estructura_global}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=80mm]{./Imagenes/flujo_malla}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=80mm]{./Imagenes/flujo_potencial}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=80mm]{./Imagenes/flujo_potencial_after}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=90mm]{./Imagenes/flujo_laplace}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=90mm]{./Imagenes/flujo_poisson}
        \caption{Diagrama de flujo para generación de mallas mediante la
            ecuación de Poisson}
        \label{flujo_poisson}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[width=90mm]{./Imagenes/flujo_potencial_funcion}
        \caption{Diagrama de flujo para generación de mallas mediante la
            ecuación de Poisson}
...
\chapter{Resultados}
    ...
    \paragraph*{}
        ...
        ángulos de ataque un perfil seleccionado, con lo que se obtiene un rango
        de valores para el ángulo de ataque en los que todavía se cuenta con una
        malla que resulte de utilidad para análisis de DFC. Normalmente este
        límite se alcanza cuando se presentan cruces en las líneas que forman la
        malla.
    ...
    \paragraph*{}
        ...
        malla, así como los casos límite de aplicabilidad
    \begin{table}[htbp!]
    \begin{center}
        \begin{tabular}{ | c | c |}
        \hline
