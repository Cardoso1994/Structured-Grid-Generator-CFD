...
\usepackage[spanish,es-tabla, es-nodecimaldot]{babel} %es-tabla para nombrar a las tablas en vez de cuadros
...
\begin{document}
    \begin{titlepage}
		\begin{center}
			\begin{figure}
				\begin{center}
					\includegraphics[keepaspectratio, width=3cm]{./Imagenes/ipn-logo}
				\end{center}
			\end{figure}
		\rule{100mm}{0.3mm}\\
		\vspace*{8mm}
...
\chapter{Discretización Espacial}\label{chap:discretizacion-espacial}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Aproximación forward]{\label{fig:grafica-forward}\includegraphics[keepaspectratio, width=65mm]{./Imagenes/grafica-forward}}
        \subfigure[Aproximación backward]{\label{fig:grafica-backward}\includegraphics[keepaspectratio, width=65mm]{./Imagenes/grafica-backward}}
        \subfigure[Aproximación central]{\label{fig:grafica-central} \includegraphics[keepaspectratio, width=65mm]{./Imagenes/grafica-central}}
...
\paragraph{}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Malla Estructurada]{\label{fig:malla-estructurada}\includegraphics[keepaspectratio, width=50mm]{./Imagenes/malla-estructurada}} \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Malla no Estructurada]{\label{fig:malla-no-estructurada}\includegraphics[keepaspectratio, width=50mm]{./Imagenes/malla-no-estructurada}}
...
\section{Generación de mallas mediante EDP}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Efecto de atracción a la línea $\xi = \xi_{m}$]{\label{fig:densidad-xi-linea}\includegraphics[keepaspectratio, width=80mm]{./Imagenes/densidad-xi-linea}}
        \hspace{1cm}
        \subfigure[Efecto de atracción al punto $(\xi_{n}, \eta_{n})$]{\label{fig:densidad-xi-punto}\includegraphics[keepaspectratio, width=80mm]{./Imagenes/densidad-xi-punto}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Efecto de atracción a la línea $\eta = \eta_{m}$]{\label{fig:densidad-eta-linea}\includegraphics[keepaspectratio, width=80mm]{./Imagenes/densidad-eta-linea}}
        \hspace{1cm}
        \subfigure[Efecto de atracción al punto $(\xi_{n}, \eta_{n})$]{\label{fig:densidad-eta-punto}\includegraphics[keepaspectratio, width=80mm]{./Imagenes/densidad-eta-punto}}
    ...
    \begin{equation}
        \left[ A \right] \frac{R_{i + 1, j} - R_{i - 1, j}}{2 \Delta \xi}
        + \left[ B \right] \frac{R_{i, j} - R_{i, j - 1}}{\Delta \eta}
        = \left[ H \right]_{i, j}
    \end{equation}\\

    que al ser multiplicada por la matriz $\left[ B \right]^{-1}$ y reacomodada queda cómo
    \begin{equation}
        \frac{R_{i, j} - R_{i, j-1} }{\Delta \eta} + \left[ B \right]^{-1}
        \left[ A \right] \frac{R_{i + 1, j} - R_{i - 1, j} }{2 \Delta \xi}
        = \left[ B \right]^{-1} H_{i, j}
    \end{equation}\\
    ...
    \begin{equation}
        \left[ AA \right] R_{i - 1, j} + \left[ BB \right] R_{i, j}
        + \left[ CC \right] R_{i + 1, j} = \left[ DD \right]_{i, j}
    ...
    \begin{subequations}
        \begin{equation*}
            \left[ AA \right] = - \frac{1}{2 \Delta \xi}
            \left[ C \right]_{i, j - 1}
        \end{equation*}
        \begin{equation*}
            \left[ BB \right] = \frac{1}{\Delta \eta} \left[ I \right]
        \end{equation*}
        \begin{equation*}
            \left[ CC \right] = \frac{1}{2 \Delta \xi}
            \left[ C \right]_{i, j - 1}
        \end{equation*}
        \begin{equation*}
            \left[ DD \right] = \left[ B \right]_{i, j - 1}^{-1} H_{i, j}
            + \frac{R_{i, j-1}}{\Delta \eta}
        \end{equation*}
    \end{subequations}\\
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio, width=110mm]{./Imagenes/eliptic_non_uniform.png}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio, width=110mm]{./Imagenes/parabolic_modified_boundary.png}
    ...
    celda y los centroides de las caras que la forman. La
    figura~\ref{aspect_ansys} es una representación gráfica de este método.
    \begin{figure}[htbp!]
        \centering
...
\chapter{Análisis de Flujo Potencial}\label{chap:potential}
    ...
    \paragraph*{}
        ...
        \begin{figure}[htbp!]
            \centering
            \includegraphics[keepaspectratio, width=115mm]{./Imagenes/kutta_condition}
    ...
    \paragraph*{}
        ...
        \begin{figure}[htbp!]
            ...
            \includegraphics[keepaspectratio, 
                width=115mm]{./Imagenes/circulacion_tiempo}
            \caption[Flujo alrededor de perfil momentos después]{Flujo
            alrededor de perfil momentos después\cite{anderson_fundamentals}}
            \label{circulacion_tiempo}
        \end{figure}

    \paragraph*{}
        En simulaciones computacionales un corte debe definirse, a lo largo del
        cual existirá una discontinuidad del potencial dado por
        \begin{equation}
    ...
    \paragraph*{}
        ...
        único método válido y que también es posible llevar a cabo la
    ...
    \paragraph*{}
        ...
        \begin{figure}[htbp!]
            \centering
            \includegraphics[keepaspectratio,
                width=115mm]{./Imagenes/malla_escalonada}
...
\chapter{Desarrollo Práctico}
    ...
    \begin{center}
        ...
        \textbf{gen\textunderscore Laplace(metodo)} & \multirow{4}{*}{
            \shortstack[l]{Genera la malla resolviendo la ecuación de Laplace.
                \\La variable metodo se refiere al método iterativo de
                solución,\\el usuario puede escoger entre Jacobi, Gauss-Seidel
                y SOR\@.\\Por default se utiliza el método SOR}} \\
        \textbf{gen\textunderscore Laplace\textunderscore v(metodo)} & \\
        \textbf{gen\textunderscore Laplace\textunderscore n(metodo)} & \\
        & \\
        \hline

        \textbf{gen\textunderscore Poisson(metodo)} & \multirow{4}{*}{
            \shortstack[l]{Genera la malla resolviendo la ecuación de Poisson.
                \\La variable metodo se refiere al método iterativo de
                solución,\\el usuario puede escoger entre Jacobi, Gauss-Seidel
                y SOR\@.\\Por default se utiliza el método SOR}} \\
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[keepaspectratio, width=70mm]{./Imagenes/flujo_malla}
    ...
    \begin{figure}[htbp!]
        ...
        \includegraphics[keepaspectratio, width=70mm]
            {./Imagenes/flujo_potencial_after}
...
\chapter{Resultados}
    ...
    % relación (1:1) y (2:1) [x:y]
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista
        Completa]{\label{fig:naca4415_far}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_far}}
        \hfill
        \subfigure[Acercamiento a
        perfil]{\label{fig:naca4415_close}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_close}}
        \caption[Malla tipo O con perfil NACA4415]{Malla tipo O con perfil NACA4415
                        con ángulo de ataque 0\si{\degree}}
        \label{fig:naca4415}
    \end{figure}

    % relación (1:1.4) [x:y]
    % malla O perfil unico naca 4415
    \begin{figure}[htbp!]
        \centering
        \subfigure[50\si{\degree} Vista del
        perfil]{\label{fig:naca4415_50_far}\includegraphics[keepaspectratio,
            width=0.40\textwidth]{./Imagenes/naca4415_50_far}}
        \hfill
        \subfigure[50\si{\degree} Vista del borde de
        salida]{\label{fig:naca4415_50_close}\includegraphics[keepaspectratio,
            width=0.4\textwidth]{./Imagenes/naca4415_50_close}}
        \subfigure[-50\si{\degree} Vista del
        perfil]{\label{fig:naca4415_-50_far}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_-50_far}}
        \hfill
        \subfigure[-50\si{\degree} Vista del borde de
        salida]{\label{fig:naca4415_-50_close}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_-50_close}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista
        completa]{\label{fig:naca4415_flap_far}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_far}}
        \hfill
        \subfigure[Acercamiento a
        perfil]{\label{fig:naca4415_flap_close}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_close}}
        \caption[Malla tipo O con perfily flap NACA 4415]{Malla tipo O con perfil
             y flap NACA4415, ambos con ángulo de ataque 0\si{\degree}}
        \label{fig:naca4415_flap}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Flap a
        50\si{\degree}]{\label{fig:naca4415_flap_50_both}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_50}}
        \hfill
        \subfigure[Acercamiento a borde de salida de perfil y borde de ataque
                de flap]{\label{fig:naca4415_flap_50_airfoil}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_50_airfoil}}
        \subfigure[Acercamiento a borde de salida de
        flap]{\label{fig:naca4415_flap_50_flap}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_50_flap}}

        \caption[Malla tipo O con perfily flap NACA4415]{Malla tipo O con
            perfil y flap NACA4415. El perfil tiene un ángulo de ataque de
             0\si{\degree} y el flap un ángulo de deflexión de 50\si{\degree}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Acercamiento a perfil y
        flap]{\label{fig:naca4415_flap_-10_both}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_-10}}
        \hfill
        \subfigure[Acercamiento a borde de salida de perfil y borde de ataque
        de flap]{\label{fig:naca4415_flap_-10_airfoil}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_-10_airfoil}}
        \subfigure[Acercamiento a borde de salida de
        flap]{\label{fig:naca4415_flap_-10_flap}\includegraphics[keepaspectratio,
        width=0.45\textwidth]{./Imagenes/naca4415_flap_-10_flap}}

        \caption[Malla tipo O con perfil y flap NACA4415 a -10\si{\degree}]{Malla tipo O con perfil
             y flap NACA4415. El perfil tiene un ángulo de ataque de
             0\si{\degree} y el flap un ángulo de deflexión de -10\si{\degree}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista
          completa]{\label{fig:naca4415_c_far}\includegraphics[keepaspectratio,
            width=0.4\textwidth]{./Imagenes/naca4415_c_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_close}\includegraphics[keepaspectratio,
            width=0.4\textwidth]{./Imagenes/naca4415_c_close}}
        \caption[Malla tipo C con perfil NACA 4415]{Malla tipo C con perfil
             NACA 4415, a un ángulo de ataque 0\si{\degree}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[50\si{\degree} Vista del
          perfil]{\label{fig:naca4415_c_50}\includegraphics[keepaspectratio,
            width=0.455\textwidth]{./Imagenes/naca4415_c_50}}
        \subfigure[-50\si{\degree} Vista del perfil]{\label{fig:naca4415_c_-50}\includegraphics[keepaspectratio,
            width=0.45\textwidth]{./Imagenes/naca4415_c_-50}}
        \caption[Malla tipo C. Vista de los límites recomendados]{Malla tipo
          C con perfil NACA 4415 con ángulo de ataque 50\si{\degree} y
          -50\si{\degree}. Límites recomendados.}
   ...
   $-30\si{\degree}$.
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista
          completa]{\label{fig:naca4415_c_flap_far}\includegraphics[keepaspectratio,
            width=0.4\textwidth]{./Imagenes/naca4415_c_flap_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_close}\includegraphics[keepaspectratio,
            width=0.4\textwidth]{./Imagenes/naca4415_c_flap_close}}
    ...
    \begin{figure}[htpb!]
        \centering
        \subfigure[Acercamiento a perfil y
        flap]{\label{fig:naca4415_c_flap_20}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_20}}
        \hfill
        \subfigure[Acercamiento a borde de salida de
        perfil y borde de ataque de
        flap]{\label{fig:naca4415_c_flap_20_both}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_20_both}}
        \subfigure[Acercamiento a borde de salida de
        flap]{\label{fig:naca4415_c_flap_20_flap}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_20_flap}}
        \caption[Malla tipo C con perfil y flap NACA4415 a
        20\si{\degree}]{Malla tipo C con perfil y flap NACA4415. El perfil
        tiene un ángulo de ataque de 0\si{\degree} y el flap un ángulo de
        deflexión de 20 \si{\degree}}
    ...
    \begin{figure}[htpb!]
        \centering
        \subfigure[Acercamiento a perfil y
        flap]{\label{fig:naca4415_c_flap_-30}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_-30}}
        \hfill
        \subfigure[Acercamiento a borde de salida de
        perfil y borde de ataque de
        flap]{\label{fig:naca4415_c_flap_-30_both}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_-30_both}}
        \subfigure[Acercamiento a borde de salida de
        flap]{\label{fig:naca4415_c_flap_-30_flap}\includegraphics[keepaspectratio,
        width=0.4\textwidth]{./Imagenes/naca4415_c_flap_-30_flap}}
        \caption[Malla tipo C con perfil y flap NACA4415 a
        -30\si{\degree}]{Malla tipo C con perfil y flap NACA4415. El perfil
        tiene un ángulo de ataque de 0\si{\degree} y el flap un ángulo de
        deflexión de -30 \si{\degree}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aspect_close}}

        \subfigure[Vista
          Completa $M=65$]{\label{fig:naca4415_m_65_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_m_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=65$]{\label{fig:naca4415_m_65_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_m_65_aspect_close}}

        \caption[Aspect ratio para malla tipo O con perfil NACA4415]{Aspect
          ratio para malla tipo O con perfil NACA4415}
        \label{fig:naca4415_aspect_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_n_65_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_n_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_n_65_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_n_65_aspect_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_aa_215_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aa_215_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_aa_215_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aa_215_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_skew_close}}

        \subfigure[Vista
          Completa $M=65$]{\label{fig:naca4415_m_65_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_m_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=65$]{\label{fig:naca4415_m_65_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_m_65_skew_close}}
    ...
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_n_65_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_n_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_n_65_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_n_65_skew_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_aa_215_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aa_215_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_aa_215_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_aa_215_skew_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_flap_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_flap_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aspect_close}}

        \subfigure[Vista
          Completa $M=123$]{\label{fig:naca4415_flap_m_123_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_m_123_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=123$]{\label{fig:naca4415_flap_m_123_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_m_123_aspect_close}}

        \caption[Aspect ratio para malla tipo O con perfil y flap NACA4415]{Aspect
          ratio para malla tipo O con perfil y flap NACA4415}
        \label{fig:naca4415_flap_aspect_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_flap_n_65_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_n_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_flap_n_65_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_n_65_aspect_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_flap_aa_215_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aa_215_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_flap_aa_215_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aa_215_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_flap_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_flap_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_skew_close}}

        \subfigure[Vista
          Completa $M=123$]{\label{fig:naca4415_flap_m_123_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_m_123_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=123$]{\label{fig:naca4415_flap_m_123_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_m_123_skew_close}}

        \caption[Skew para malla tipo O con perfil y flap NACA4415]{Skew para malla
          tipo O con perfil y flap NACA4415}
        \label{fig:naca4415_flap_skew_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_flap_n_65_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_n_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_flap_n_65_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_n_65_skew_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_flap_aa_215_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aa_215_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_flap_aa_215_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_flap_aa_215_skew_close}}
    ...
    perfil NACA 4415, se analizan el aspect ratio y el skew de
    la misma, haciendo variaciones en los parámetros que la definen. Los cambios
    realizados son $M$ de $M=73$ a $M=93$, $N$ de $N=45$ a $N=65$ y $aa_{m}$ de
    $aa_{m} = 20.5$ a $aa_{m}=21.5$. Las gráficas de las
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aspect_close}}

        \subfigure[Vista
          Completa $M=91$]{\label{fig:naca4415_c_m_91}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_m_91_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=91$]{\label{fig:naca4415_c_m_91}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_m_91_aspect_close}}

        \caption[Aspect ratio para malla tipo C con perfil NACA4415]{Aspect
          ratio para malla tipo C con perfil NACA4415}
        \label{fig:naca4415_c_aspect_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_n_65_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_n_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_n_65_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_n_65_aspect_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_aa_215_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aa_215_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_aa_215_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aa_215_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_skew_close}}

        \subfigure[Vista
          Completa $M=91$]{\label{fig:naca4415_c_m_91_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_m_91_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=91$]{\label{fig:naca4415_c_m_91_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_m_91_skew_close}}
    ...
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_n_65_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_n_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_n_65_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_n_65_skew_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_aa_215_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aa_215_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_aa_215_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_aa_215_skew_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_flap_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aspect_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aspect_close}}

        \subfigure[Vista
          Completa $M=193$]{\label{fig:naca4415_c_flap_m_193_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_m_193_aspect_far}}
        \subfigure[Acercamiento a
          perfil $M=193$]{\label{fig:naca4415_c_flap_m_193_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_m_193_aspect_close}}

        \caption[Aspect ratio para malla tipo C con perfil y flap NACA4415]{Aspect
          ratio para malla tipo C con perfil y flap NACA4415}
        \label{fig:naca4415_c_flap_aspect_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_flap_n_65_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_n_65_aspect_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_flap_n_65_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_n_65_aspect_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_flap_aa_215_aspect_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aa_215_aspect_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_flap_aa_215_aspect_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aa_215_aspect_close}}
    ...
    \begin{figure}[H]
        ...
        \subfigure[Vista
          Completa]{\label{fig:naca4415_c_flap_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_skew_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_skew_close}}

        \subfigure[Vista
          Completa $M=193$]{\label{fig:naca4415_c_flap_m_193_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_m_193_skew_far}}
        \subfigure[Acercamiento a
          perfil $M=193$]{\label{fig:naca4415_c_flap_m_193_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_m_193_skew_close}}

        \caption[Skew para malla tipo C con perfil y flap NACA4415]{Skew para
          malla tipo C con perfil y flap NACA4415}
        \label{fig:naca4415_c_flap_skew_0}
    \end{figure}
    \begin{figure}[H]
        \centering
        \subfigure[Vista
          Completa $N=65$]{\label{fig:naca4415_c_flap_n_65_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_n_65_skew_far}}
        \subfigure[Acercamiento a
          perfil $N=65$]{\label{fig:naca4415_c_flap_n_65_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_n_65_skew_close}}

        \subfigure[Vista
          Completa $a=21.5$]{\label{fig:naca4415_c_flap_aa_215_skew_far}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aa_215_skew_far}}
        \subfigure[Acercamiento a
          perfil $a=21.5$]{\label{fig:naca4415_c_flap_aa_215_skew_close}\includegraphics[keepaspectratio,
            width=0.49\textwidth]{./Imagenes/naca4415_c_flap_aa_215_skew_close}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista Completa]{\label{fig:potential_flow_mesh_far}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_mesh_far}}
        \hfill
          \subfigure[Acercamiento a perfil]{\label{fig:potential_flow_mesh_close}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_mesh_close}}
        \caption{Malla generada para el análisis de flujo potencial de perfil
        NACA 0012}
        \label{fig:potential_flow_mesh}
    \end{figure}

    \begin{figure}[H]
        \subfigure[Vista Completa]{\label{fig:potential_flow_potential_far}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_potential_far}}
        \hfill
        \subfigure[Acercamiento a perfil]{\label{fig:potential_flow_potential_close}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_potential_close}}
    ...
    \begin{figure}[H]%[htbp!]
        \centering
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_cp_-4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_-4}}
      \hfill
      \subfigure[$\alpha = -2\si{\degree}$]{\label{fig:potential_flow_cp_-2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_-2}}
      \subfigure[$\alpha = 0\si{\degree}$]{\label{fig:potential_flow_cp_0_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_0}}
      \hfill
      \subfigure[$\alpha = 2\si{\degree}$]{\label{fig:potential_flow_cp_2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_2}}
    \end{figure}
    ...
    \begin{figure}[H]%[htbp!]
      ...
      \subfigure[$\alpha = 2\si{\degree}$]{\label{fig:potential_flow_cp_2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_2}}
        \subfigure[$\alpha = 4\si{\degree}$]{\label{fig:potential_flow_cp_4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_cp_4}}
        \hfill
        \subfigure[$\alpha = 6\si{\degree}$]{\label{fig:potential_flow_cp_6}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_cp_6}}
        \caption{Campo de presiones alrededor de perfil NACA 0012}
        \label{fig:potential_flow_cp_0}
    \end{figure}
    \begin{figure}[htpb!]
        \subfigure[$\alpha = 8\si{\degree}$]{\label{fig:potential_flow_cp_8}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_cp_8}}
        \hfill
        \subfigure[$\alpha = 10\si{\degree}$]{\label{fig:potential_flow_cp_10}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_cp_10}}
      \caption{Campo de presiones alrededor de perfil NACA 0012}
        \label{fig:potential_flow_cp_1}
    \end{figure}

    \begin{figure}[htbp!]
        \centering
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_stream_-4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_-4_}}
        \hfill
        \subfigure[$\alpha = -2\si{\degree}$]{\label{fig:potential_flow_stream_-2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_-2_}}
        \subfigure[$\alpha =
          0\si{\degree}$]{\label{fig:potential_flow_stream_0_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_0_}}
        \hfill
        \subfigure[$\alpha = 2\si{\degree}$]{\label{fig:potential_flow_stream_2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_2_}}
        \subfigure[$\alpha =
          4\si{\degree}$]{\label{fig:potential_flow_stream_4_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_4_}}
        \hfill
        \subfigure[$\alpha =
          6\si{\degree}$]{\label{fig:potential_flow_stream_6_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_6_}}
    ...
    \begin{figure}[htbp!]
        \subfigure[$\alpha =
          8\si{\degree}$]{\label{fig:potential_flow_stream_8_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_8_}}
        \hfill
        \subfigure[$\alpha =
          10\si{\degree}$]{\label{fig:potential_flow_stream_10}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_stream_10_}}
        \caption{Líneas de corriente alrededor de perfil NACA 0012}
        \label{fig:potential_flow_stream_1}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio,
            width=0.8\textwidth]{./Imagenes/potential_flow_cps}
    ...
    \begin{figure}[htbp!]
        \centering
        \includegraphics[keepaspectratio,
            width=0.55\textwidth]{./Imagenes/potential_flow_cl}
    ...
    genera alrededor del perfil para diferentes ángulos de ataque. Por otro
    lado las figuras~\ref{fig:potential_flow_2412_stream_0}
    y~\ref{fig:potential_flow_2412_stream_1} muestran las líneas de corriente
    del flujo para los mismos ángulos de ataque.

    \begin{figure}[H]
        \centering
        \subfigure[Vista Completa]{\label{fig:potential_flow_2412_potential_far}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_potential_far}}
        \hfill
        \subfigure[Acercamiento a perfil]{\label{fig:potential_flow_2412_potential_close}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_potential_close}}
        \caption{Lineas equipotenciales para $\alpha = 0\si{\degree}$ para
          perfil NACA 2412}\label{fig:potential_flow_2412_potential}
    \end{figure}

    \begin{figure}[htbp!]
        \centering
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_2412_cp_-4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_-4}}
        \hfill
        \subfigure[$\alpha = -2\si{\degree}$]{\label{fig:potential_flow_2412_cp_-2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_-2}}
        \subfigure[$\alpha =
          0\si{\degree}$]{\label{fig:potential_flow_2412_cp_0_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_0}}
        \hfill
        \subfigure[$\alpha = 2\si{\degree}$]{\label{fig:potential_flow_2412_cp_2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_2}}
        \subfigure[$\alpha = 4\si{\degree}$]{\label{fig:potential_flow_2412_cp_4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_4}}
        \hfill
        \subfigure[$\alpha = 6\si{\degree}$]{\label{fig:potential_flow_2412_cp_6}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_6}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[$\alpha = 8\si{\degree}$]{\label{fig:potential_flow_2412_cp_8}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_8}}
        \hfill
        \subfigure[$\alpha = 10\si{\degree}$]{\label{fig:potential_flow_2412_cp_10}\includegraphics[keepaspectratio,
          width=0.48\textwidth]{./Imagenes/potential_flow_2412_cp_10}}
        \caption{Campo de presiones alrededor de perfil NACA 2412}
        \label{fig:potential_flow_2412_cp_1}
    \end{figure}

    \begin{figure}[H]%[htbp!]
        \centering
        \subfigure[$\alpha = -4\si{\degree}$]{\label{fig:potential_flow_2412_stream_-4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_-4}}
          \subfigure[$\alpha = -2\si{\degree}$]{\label{fig:potential_flow_2412_stream_-2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_-2}}
          \subfigure[$\alpha =
          0\si{\degree}$]{\label{fig:potential_flow_2412_stream_0_}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_0}}
          \subfigure[$\alpha = 2\si{\degree}$]{\label{fig:potential_flow_2412_stream_2}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_2}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[$\alpha = 4\si{\degree}$]{\label{fig:potential_flow_2412_stream_4}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_4}}
          \subfigure[$\alpha = 6\si{\degree}$]{\label{fig:potential_flow_2412_stream_6}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_6}}
          \subfigure[$\alpha = 8\si{\degree}$]{\label{fig:potential_flow_2412_stream_8}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_8}}
          \subfigure[$\alpha = 10\si{\degree}$]{\label{fig:potential_flow_2412_stream_10}\includegraphics[keepaspectratio,
            width=0.48\textwidth]{./Imagenes/potential_flow_2412_stream_10}}
        \caption{Líneas de corriente alrededor de perfil NACA 2412}
        \label{fig:potential_flow_2412_stream_1}
    \end{figure}
    ...
    \begin{figure}[H]%[htbp!]
        \centering
        \includegraphics[keepaspectratio,
            width=0.55\textwidth]{./Imagenes/potential_flow_2412_cps}
    ...
    \begin{figure}[H]%[htbp!]
        \centering
        \includegraphics[keepaspectratio,
            width=0.55\textwidth]{./Imagenes/potential_flow_2412_cl}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mc_cp_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]
        {./Imagenes/su2/mc_cp_alfa_0.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mc_vel_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]{./Imagenes/su2/mc_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo C de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 0\si{\degree}$}
        \label{fig:mc_su2_0}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mc_cp_10}\includegraphics[keepaspectratio,
        width=0.75\textwidth]
        {./Imagenes/su2/mc_cp_alfa_10.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mc_vel_10}\includegraphics[keepaspectratio,
        width=0.75\textwidth]{./Imagenes/su2/mc_vel_alfa_10.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo C de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 10\si{\degree}$}
        \label{fig:mc_su2_10}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mo_cp_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]
        {./Imagenes/su2/mo_cp_alfa_0.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mo_vel_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]{./Imagenes/su2/mo_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo O de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 0\si{\degree}$}
        \label{fig:mo_su2_0}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mo_cp_10}\includegraphics[keepaspectratio,
        width=0.75\textwidth]
        {./Imagenes/su2/mo_cp_alfa_10.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mo_vel_10}\includegraphics[keepaspectratio,
        width=0.75\textwidth]{./Imagenes/su2/mo_vel_alfa_10.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo O de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 10\si{\degree}$}
        \label{fig:mo_su2_10}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mc_flap_cp_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]
        {./Imagenes/su2/mc_flap_cp_alfa_0.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mc_flap_vel_0}\includegraphics[keepaspectratio,
        width=0.75\textwidth]{./Imagenes/su2/mc_flap_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo C de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 0\si{\degree}$ y un flap con deflexión
        $\delta = 15\si{\degree}$}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Campo de
        presión]{\label{fig:mo_flap_cp_0}\includegraphics[keepaspectratio,
        width=150mm]
        {./Imagenes/su2/mo_flap_cp_alfa_0.png}}
        % \hspace{20mm} %marca separación entre subfiguras
        \subfigure[Campo de
        velocidad]{\label{fig:mo_flap_vel_0}\includegraphics[keepaspectratio,
        width=150mm]{./Imagenes/su2/mo_flap_vel_alfa_0.png}}
        \caption[Resultados de simulaciones para malla C]{Resultados de la
        simulación en SU2 con una malla tipo O de un perfil NACA 0012 con
        ángulo de ataque $\alpha = 0\si{\degree}$ y un flap con deflexión
        $\delta = 15\si{\degree}$}
