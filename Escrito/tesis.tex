...
\chapter{Resultados}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Flap a 40\si{\degree}]{\label{fig:naca4415_flap_40}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_40}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Acercamiento a perfil y flap]{\label{fig:naca4415_flap_-20}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_-20}}
        \subfigure[Acercamiento a borde de salida de perfil y borde de ataque de
    ...
    \begin{center}
        ...
        Ángulo mínimo & -90\si{\degree}
        \\ \hline

        Ángulo mínimo recomendado & -80\si{\degree}
        \\ \hline
        \end{tabular}
    ...
    \begin{figure}[htbp!]
        ...
        \caption[Malla tipo C con perfily flap NACA4415]{Malla tipo O con perfil
    ...
    \begin{figure}[htbp!]
        ...
        \caption[Malla tipo C con perfil NACA4415 a -80\si{\degree}]{Malla tipo
          C con perfil NACA 4415 con ángulo de ataque 90\si{\degree}.
