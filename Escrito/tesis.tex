...
\pagenumbering{arabic}
    ...
    \paragraph*{Helyx}
    Paquete \textit{``open source''} para análisis de dinámica de fluidos
...
\chapter{Resultados}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista Completa]{\label{fig:naca4415_far}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_far}}
        \subfigure[Acercamiento a perfil]{\label{fig:naca4415_close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_close}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[90\si{\degree} Vista del perfil]{\label{fig:naca4415_90_far}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_90_far}}
        \subfigure[90\si{\degree} Vista del borde de salida]{\label{fig:naca4415_90_close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_90_close}}
        ...
        \label{fig:naca4415_90}
    \end{figure}

    % relación (1:1.4) [x:y]
    \begin{figure}[htbp!]
        \centering
        \subfigure[-90\si{\degree} Vista del perfil]{\label{fig:naca4415_-90_far}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_-90_far}}
        \subfigure[-90\si{\degree} Vista del borde de salida]{\label{fig:naca4415_-90_close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_-90_close}}
        \caption[Malla tipo O con perfil NACA4415 a 90\si{\degree}]{Malla tipo O con perfil NACA4415
                        con ángulo de ataque 90\si{\degree}. Acercamiento al perfil y al borde de salida}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Vista completa]{\label{fig:naca4415_flap_far}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_far}}
        \subfigure[Acercamiento a perfil]{\label{fig:naca4415_flap_close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_close}}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[Flap a 40\si{\degree}]{\label{fig:naca4415_flap_40_both}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_40}}
        \subfigure[Acercamiento a borde de salida de perfil y borde de ataque de
        flap]{\label{fig:naca4415_flap_40_airfoil}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_40_airfoil}}
        \subfigure[Acercamiento a borde de salida de flap]{\label{fig:naca4415_flap_40_flap}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_40_flap}}

        \caption[Malla tipo O con perfily flap NACA4415]{Malla tipo O con perfil
             y flap NACA4415. El perfil tiene un ángulo de ataque de
             0\si{\degree} y el flap un ángulo de deflexión de 40\si{\degree}}
        \label{fig:naca4415_flap_40}
    \end{figure}

    % relación (2:1) [x:y]
    \begin{figure}[htbp!]
        \centering
        \subfigure[Acercamiento a perfil y flap]{\label{fig:naca4415_flap_-20_both}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_-20}}
        \subfigure[Acercamiento a borde de salida de perfil y borde de ataque de
        flap]{\label{fig:naca4415_flap_-20_airfoil}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_-20_airfoil}}
        \subfigure[Acercamiento a borde de salida de flap]{\label{fig:naca4415_flap_-20_flap}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_-20_flap}}

        \caption[Malla tipo O con perfil y flap NACA4415 a -20\si{\degree}]{Malla tipo O con perfil
             y flap NACA4415. El perfil tiene un ángulo de ataque de
             0\si{\degree} y el flap un ángulo de deflexión de -20\si{\degree}}
        \label{fig:naca4415_flap_-20}
    \end{figure}
    ...
    \begin{figure}[htbp!]
        \centering
        \subfigure[-80\si{\degree} Vista del
          perfil]{\label{fig:naca4415_c_-80_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_-80_far}}
        \subfigure[-80\si{\degree} Vista del borde de
          ataque]{\label{fig:naca4415_c_-80_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_-80_close}}
        \caption[Malla tipo C con perfil NACA4415 a -80\si{\degree}]{Malla tipo
          C con perfil NACA 4415 con ángulo de ataque -80\si{\degree}.
          Acercamiento al perfil y al borde de ataque}
        \label{fig:naca4415_c_-80}
    \end{figure}

    % relación (1:1.4) [x:y]
    \begin{figure}[htbp!]
        \centering
        \subfigure[-130\si{\degree} Vista del
          perfil]{\label{fig:naca4415_c_-130_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_-130_far}}
        \subfigure[-130\si{\degree} Vista del borde de
          ataque]{\label{fig:naca4415_c_-130_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_-130_close}}
    ...
    \begin{figure}[htbp!]
        ...
        \subfigure[Vista
          completa]{\label{fig:naca4415_c_flap_far}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_far}}
        \subfigure[Acercamiento a
          perfil]{\label{fig:naca4415_c_flap_close}\includegraphics[keepaspectratio,
            width=87mm]{./Imagenes/naca4415_c_flap_close}}
