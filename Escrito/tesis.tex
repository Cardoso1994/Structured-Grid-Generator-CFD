...
\chapter{Resultados}
   ...
   varía.
    ...
    aerodinámico NACA 2412 de la serie de cuatro dígitos, con cuerda unitaria
    ...
    malla de dimensiones $M = 95$ y $N = 65$. Para el resto de casos se utilizan
    los mismos parámetros, lo único que cambia es la rotación del perfil alar.
    Por simplicidad solo se muestra a detalle el caso ya mencionado, ya que las
    demás mallas son demasiado similares entre si.
