...
\chapter{Resultados}
    ...
    \paragraph*{}
        ...
        configuración. La figura \ref{fig:naca4415_flap} presenta la
        malla generada, tanto una vista completa de la misma, así como un
        acercamiento en el cual se logra apreciar tanto el perfil como el flap,
        el cual tiene un ángulo de deflexión igual a 0\si{\degree}. Por su parte
        la figura \ref{fig:naca4415_flap_40} muestra una malla generada bajo los
    ...
    \begin{figure}[htbp!]
        ...
        \subfigure[Acercamiento a perfil]{\label{fig:naca4415_flap:close}\includegraphics[keepaspectratio, width=87mm]{./Imagenes/naca4415_flap_close}}
